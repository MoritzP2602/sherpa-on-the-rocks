...
void C3_1::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p1_2 = p[1]-p[2];
  CE.TChannelMomenta(p[0],p1_2,p[4],p[3],s4,s3,0.,m_alpha,m_ctmax,m_ctmin,ran[3],ran[4]);
}
...
void C3_1::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  if (m_kTC_0__1_2_4_3.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_2_4_3<<CE.TChannelWeight(p[0],p1_2,p[4],p[3],0.,m_alpha,m_ctmax,m_ctmin,m_kTC_0__1_2_4_3[0],m_kTC_0__1_2_4_3[1]);
...
{
  return std::string("CG2$MTH_34$TC_0__1_2_4_3$TC_0__1__34_2$ZS_0$");
}
