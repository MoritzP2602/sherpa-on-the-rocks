...
namespace PHASIC {
  class C3_8 : public Single_Channel {
    ...
    Info_Key m_kTC_0_2_1__3_4,m_kTC_0__1__2_34,m_kZS_0;
    Vegas* p_vegas;
  public:
...
void C3_8::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p34;
  double s34 = CE.ThresholdMomenta(m_thexp,4.*sqrt(s34_min),s34_min,s34_max,ran[0]);
  double s2 = p_ms[2];
  CE.TChannelMomenta(p[0],p[1],p[2],p34,s2,s34,0.,m_alpha,m_ctmax,m_ctmin,ran[1],ran[2]);
  Vec4D  p0_2 = p[0]-p[2];
  CE.TChannelMomenta(p0_2,p[1],p[3],p[4],s3,s4,0.,m_alpha,m_ctmax,m_ctmin,ran[3],ran[4]);
}
...
void C3_8::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  wt *= CE.ThresholdWeight(m_thexp,4.*sqrt(s34_min),s34_min,s34_max,s34,p_rans[0]);
  double s2 = p_ms[2];
  ...
  Vec4D  p0_2 = p[0]-p[2];
  if (m_kTC_0_2_1__3_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_2_1__3_4<<CE.TChannelWeight(p0_2,p[1],p[3],p[4],0.,m_alpha,m_ctmax,m_ctmin,m_kTC_0_2_1__3_4[0],m_kTC_0_2_1__3_4[1]);
  wt *= m_kTC_0_2_1__3_4.Weight();

  p_rans[3]= m_kTC_0_2_1__3_4[0];
  p_rans[4]= m_kTC_0_2_1__3_4[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_ctmax = 1.;
  m_ctmin = -1.;
  m_kTC_0_2_1__3_4.Assign(std::string("TC_0_2_1__3_4"),2,0,info);
...
{
  return std::string("CG2$MTH_34$TC_0_2_1__3_4$TC_0__1__2_34$ZS_0$");
}
