...
void C3_11::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  if (m_kI_2_34.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kI_2_34<<CE.Isotropic2Weight(p[2],p234-p[2],m_kI_2_34[0],m_kI_2_34[1]);
  wt *= m_kI_2_34.Weight();

  p_rans[1]= m_kI_2_34[0];
  p_rans[2]= m_kI_2_34[1];
  if (m_kI_3_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kI_3_4<<CE.Isotropic2Weight(p[3],p34-p[3],m_kI_3_4[0],m_kI_3_4[1]);
  wt *= m_kI_3_4.Weight();
...
{
  return std::string("CG2$I_2_34$I_3_4$MTH_34$ZS_0$");
}
