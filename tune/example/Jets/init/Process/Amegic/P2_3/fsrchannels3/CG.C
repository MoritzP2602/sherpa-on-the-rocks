...
namespace PHASIC {
  ...
  public:
    ...
    int GenerateChannels()
    {
      ...
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_20",psh));
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_19",psh));
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_18",psh));
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_17",psh));
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_16",psh));
      p_mc->Add(LoadChannel(nin,nout,fl,"C3_15",psh));
