...
void C3_13::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  if (m_kI_3_24.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kI_3_24<<CE.Isotropic2Weight(p[3],p234-p[3],m_kI_3_24[0],m_kI_3_24[1]);
  wt *= m_kI_3_24.Weight();

  p_rans[1]= m_kI_3_24[0];
  p_rans[2]= m_kI_3_24[1];
  if (m_kI_2_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kI_2_4<<CE.Isotropic2Weight(p[2],p24-p[2],m_kI_2_4[0],m_kI_2_4[1]);
  wt *= m_kI_2_4.Weight();
...
{
  return std::string("CG2$I_2_4$I_3_24$MTH_24$ZS_0$");
}
