...
namespace PHASIC {
  class C3_7 : public Single_Channel {
    ...
    Info_Key m_kTC_0_4_1__2_3,m_kTC_0__1__4_23,m_kZS_0;
    Vegas* p_vegas;
  public:
...
void C3_7::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p0_4 = p[0]-p[4];
  CE.TChannelMomenta(p0_4,p[1],p[2],p[3],s2,s3,0.,m_alpha,m_ctmax,m_ctmin,ran[3],ran[4]);
}
...
void C3_7::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  Vec4D  p0_4 = p[0]-p[4];
  if (m_kTC_0_4_1__2_3.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_4_1__2_3<<CE.TChannelWeight(p0_4,p[1],p[2],p[3],0.,m_alpha,m_ctmax,m_ctmin,m_kTC_0_4_1__2_3[0],m_kTC_0_4_1__2_3[1]);
  wt *= m_kTC_0_4_1__2_3.Weight();

  p_rans[3]= m_kTC_0_4_1__2_3[0];
  p_rans[4]= m_kTC_0_4_1__2_3[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_ctmax = 1.;
  m_ctmin = -1.;
  m_kTC_0_4_1__2_3.Assign(std::string("TC_0_4_1__2_3"),2,0,info);
...
{
  return std::string("CG2$MTH_23$TC_0_4_1__2_3$TC_0__1__4_23$ZS_0$");
}
