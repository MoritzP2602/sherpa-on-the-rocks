...
namespace PHASIC {
  class C3_6 : public Single_Channel {
    ...
    Info_Key m_kTC_0_2_1__4_3,m_kTC_0__1__2_34,m_kZS_0;
    Vegas* p_vegas;
  public:
...
void C3_6::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p0_2 = p[0]-p[2];
  CE.TChannelMomenta(p0_2,p[1],p[4],p[3],s4,s3,0.,m_alpha,m_ctmax,m_ctmin,ran[3],ran[4]);
}
...
void C3_6::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  Vec4D  p0_2 = p[0]-p[2];
  if (m_kTC_0_2_1__4_3.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_2_1__4_3<<CE.TChannelWeight(p0_2,p[1],p[4],p[3],0.,m_alpha,m_ctmax,m_ctmin,m_kTC_0_2_1__4_3[0],m_kTC_0_2_1__4_3[1]);
  wt *= m_kTC_0_2_1__4_3.Weight();

  p_rans[3]= m_kTC_0_2_1__4_3[0];
  p_rans[4]= m_kTC_0_2_1__4_3[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_ctmax = 1.;
  m_ctmin = -1.;
  m_kTC_0_2_1__4_3.Assign(std::string("TC_0_2_1__4_3"),2,0,info);
...
{
  return std::string("CG2$MTH_34$TC_0_2_1__4_3$TC_0__1__2_34$ZS_0$");
}
