...
namespace PHASIC {
  class C3_20 : public Single_Channel {
    double m_thexp;
    double m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kTC_0_3_1__4_2,m_kTC_0__1__3_24,m_kZS_0;
    Vegas* p_vegas;
  public:
    C3_20(int,int,Flavour*,Integration_Info * const);
    ~C3_20();
...
extern "C" Single_Channel * Getter_C3_20(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C3_20(nin,nout,fl,info);
}

void C3_20::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p0_3 = p[0]-p[3];
  CE.TChannelMomenta(p0_3,p[1],p[4],p[2],s4,s2,0.,m_alpha,m_ctmax,m_ctmin,ran[3],ran[4]);
}

void C3_20::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p234=p[0]+p[1];
  double s234_max = p234.Abs2();
  ...
  Vec4D  p0_3 = p[0]-p[3];
  if (m_kTC_0_3_1__4_2.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_3_1__4_2<<CE.TChannelWeight(p0_3,p[1],p[4],p[2],0.,m_alpha,m_ctmax,m_ctmin,m_kTC_0_3_1__4_2[0],m_kTC_0_3_1__4_2[1]);
  wt *= m_kTC_0_3_1__4_2.Weight();

  p_rans[3]= m_kTC_0_3_1__4_2[0];
  p_rans[4]= m_kTC_0_3_1__4_2[1];
...
C3_20::C3_20(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  Settings& s = Settings::GetMainSettings();
  m_name = std::string("C3_20");
  m_rannum = 5;
  ...
  m_ctmax = 1.;
  m_ctmin = -1.;
  m_kTC_0_3_1__4_2.Assign(std::string("TC_0_3_1__4_2"),2,0,info);
...
void C3_20::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 0;
  width = 0.;
...
void C3_20::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,p_rans);
}
std::string C3_20::ChID()
{
  return std::string("CG2$MTH_24$TC_0_3_1__4_2$TC_0__1__3_24$ZS_0$");
}
